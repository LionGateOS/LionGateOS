...
export function initializeProviders() {
    ...
    const expediaConfig = {
        apiKey: import.meta.env.VITE_EXPEDIA_API_KEY || '',
        apiSecret: import.meta.env.VITE_EXPEDIA_API_SECRET || '',
        affiliateId: import.meta.env.VITE_EXPEDIA_AFFILIATE_ID || 'liongateos',
    };
 ...
 */
export function hasRealProviders() {
    return !!import.meta.env.VITE_EXPEDIA_API_KEY;
}
