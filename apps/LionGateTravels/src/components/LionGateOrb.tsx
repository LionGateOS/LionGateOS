...
interface LionGateOrbProps {
  size?: number;
  initialX?: 'right' | 'left' | number;
  initialY?: 'bottom' | 'top' | number;
}
 ...
 */
export default function LionGateOrb({ size = 100, initialX = 'right', initialY = 'bottom' }: LionGateOrbProps) {
  ...
  return (
    <div 
      ...
      title={`Global State Monitor: ${activeZone || 'Idle'} / ${activeSeverity || 'Normal'}`}
    >
