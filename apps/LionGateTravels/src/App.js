...
const HeroSection = () => {
    ...
    return (_jsxs("div", { ref: ref, className: "relative h-64 overflow-hidden rounded-xl mb-4", children: [_jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-violet-900/50 via-fuchsia-900/30 to-cyan-900/50", style: { transform: `translateY(${offset}px)` } }), _jsx("div", { className: "absolute inset-0 bg-obsidian-mesh" }), _jsxs("div", { className: "absolute top-0 bottom-0 left-12 flex items-center gap-8", children: [_jsx("div", { className: "h-full flex items-center", children: _jsx("img", { src: Logo, alt: "LionGateOS Logo", className: "w-[10rem] h-[10rem] object-contain drop-shadow-[0_0_20px_rgba(0,245,255,0.3)]" }) }), _jsxs("div", { className: "flex flex-col justify-center h-[10rem]", children: [_jsx("h1", { className: "text-6xl font-black text-gradient-cyan tracking-tight leading-none mb-2", children: "LionGateOS Travels" }), _jsx("p", { className: "text-xl text-white/60 tracking-[0.2em] font-light", children: "GLOBAL TRAVEL OPERATING SYSTEM" })] })] }), _jsxs("div", { className: "absolute inset-x-0 bottom-12 flex items-center justify-center gap-6", children: [_jsxs(MagneticButton, { variant: "primary", className: "shadow-lg shadow-cyan-500/20", children: [_jsx(Plane, { className: "w-5 h-5 mr-3" }), _jsx("span", { className: "tracking-widest", children: "EXPLORE" })] }), _jsxs(MagneticButton, { variant: "secondary", className: "backdrop-blur-md", children: [_jsx(Compass, { className: "w-5 h-5 mr-3" }), _jsx("span", { className: "tracking-widest", children: "DISCOVER" })] })] }), _jsx("div", { className: "absolute top-4 right-12 w-20 h-20 border border-cyan-500/20 rounded-full animate-pulse" }), _jsx("div", { className: "absolute bottom-4 right-32 w-32 h-32 border border-fuchsia-500/20 rounded-full animate-pulse", style: { animationDelay: '1s' } })] }));
};
// ============================================
// MAIN APP
// ============================================
